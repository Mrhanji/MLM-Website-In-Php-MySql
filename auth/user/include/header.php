...
if($myrole==1){
                      echo '  <li class="sidebar-item"> <a class="sidebar-link" href="memberlist.php"
                   ...
                   ?>     
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="https://bichoobag.in/auth/user/chat.php"
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="https://bichoobag.in/auth/user/changepass.php"
