            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Genealogy List</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Activity</li>
                                    <li class="breadcrumb-item text-muted" aria-current="page">Genealogy List</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<iframe src="chart.php?code=<?php echo $mycode; ?>" height="500px" width=" 100%" style="border: none;"></iframe>
