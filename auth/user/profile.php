...
if(isset($_POST['sumbit'])){
        ...
        $ifsc = mysqli_real_escape_string($connection,$_POST['ifsc']);
         $upi = mysqli_real_escape_string($connection,$_POST['upi']);
          $pan = mysqli_real_escape_string($connection,$_POST['pancard']);
              ...
              $veera= "UPDATE userbase SET Pancard = '{$pan}' WHERE  Code= '{$mycode}'; ";
    ...
    header("Location: https://bichoobag.in/auth/user/profile.php");
}
                            ...
                            <form action="<?php  $_SERVER['PHP_SELF']; ?> " method="POST">
                                <div class="form-row">
                                  ...
                                  <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="inputPassword4" placeholder="Account Number" name="acnumber" value="<?php echo $myanumber;?>">
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label for="inputAddress">Bank Name</label>
                                  <input type="text" class="form-control" id="inputAddress" placeholder="Bank Name" name="bname"value="<?php echo $mybankname;?>">
                                </div>
                                
                                <div class="form-group">
                                  <label for="inputAddress2">IFSC Code</label>
                                  <input type="text" class="form-control" id="inputAddress2" placeholder="Enter Your IFSC Code" name="ifsc" value="<?php echo $mybankifsc;?>">
                                </div>
                                <div class="form-row">
                                  <div class="form-group col-md-6">
                                    <label for="inputCity">Paytm/Upi Id</label>
                                    <input type="text" class="form-control" id="inputCity " placeholder="Enter your Paytm Number or Upi ID" name="upi" value="<?php echo $myupi;?>"> 
                                  </div>
                                  
                                  <div class="form-group col-md-2">
                                    <label for="inputZip">Pan Number*</label>
                                    <input type="text" class="form-control" id="inputZip" placeholder="Pan Card Number" required="" name="pancard" value="<?php echo $mypancard;?>">
                                  </div>
                                </div>
                                <div class="form-group">
