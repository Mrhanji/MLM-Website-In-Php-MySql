      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-md-3 col-xl-4  d-block">
            <h1 class="mb-0 site-logo"><a href="index.html" class="text-black h2 mb-0">BichooBag<span class="text-primary">.</span> </a></h1>
          </div>
...
-->
              ...
              <!--  <li><a href="#blog-section" class="nav-link">Blog</a></li>-->
                ...
                <li><a href="https://bichoobag.in/auth/user/login.php" class="nav-link">Login</a></li>
              </ul>
            </nav>
          </div>
      ...
      <div class="container">
        ...
        <div class="row mb-5">
          ...
          <div class="col-lg-5 ml-auto pl-lg-5">
            ...
            <p class="mb-4">Tries To Serve Each
Section Of Society and
Try To Improve Their Living Standard.</p>
            <ul class="ul-check mb-5 list-unstyled success">
              <li>Laborum enim quasi at modi</li>
              <li>Ad at tempore</li>
              <li>Labore quaerat esse</li>
            </ul>
            <p><a href="https://bichoobag.in/auth/user/" class="btn btn-primary">Join us</a></p>
          </div>
        </div>
...
Made with ❤️ By  <a href="https://indiesoft.in" target="_blank" >IndieSoft</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
        </div>
...
s1.async=true;
s1.src='https://embed.tawk.to/5f75bc62f0e7167d00154ffe/default';
s1.charset='UTF-8';
